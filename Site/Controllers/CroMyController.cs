...
namespace Res.Controllers
{
	...
	public class CroMyController : CroBaseController
	{
		...
		public ActionResult Edit(ResUser model)
		{
			...
			APBplDef.ResUserBpl.UpdatePartial(ResSettings.SettingsInSession.UserId, new { model.RealName, model.Email, model.PhotoPath, model.Phone, model.Company, model.ProvinceId, model.AreaId, model.IDCard });
